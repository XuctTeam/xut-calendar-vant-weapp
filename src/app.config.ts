 ...
 * @LastEditTime: 2022-07-22 17:48:48
...
export default defineAppConfig({
  pages: ['pages/index/index', 'pages/memberuserinfo/index', 'pages/tabAndSearchPagination/index', 'pages/login/index', 'pages/calendarmanager/index'],
  window: {
    // @ts-ignore
