...
export default {
   ...
   * @author: Derek Xu
   */
  sendForgetEmailCode(email: string) {
   ...
   * @author: Derek Xu
   */
  forgetPasswordCheck(phone: string, email: string, code: string, type: number) {
   ...
   * @author: Derek Xu
   */
  forgetModify(memberId: string, pwd: string, code: string) {
