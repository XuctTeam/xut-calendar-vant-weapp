 ...
 * @LastEditTime: 2022-08-01 09:54:25
...
export default Unite(
  {
    ...
    commit() {
      ...
      update(Object.assign({}, this.state, { createMemberName: this.hooks['userInfo'].name, checked: true, alarmType: this.state.alarmType.toString() }))
        .then(() => {
          this._success('修改成功')
        })
        .catch((error) => {
