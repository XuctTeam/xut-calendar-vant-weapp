 ...
 * @LastEditTime: 2022-08-08 15:25:52
      ...
      >
        <View className="box">
          ...
          <Cell title="显示方式">
            <Switch
              checked={display === 1}
              onChange={(e) => setDisplay(e.detail ? 1 : 0)}
            ></Switch>
          </Cell>
          ...
          <Cell title="共享方式">
            <Switch
              checked={isShare === 1}
              onChange={(e) => setIsShare(e.detail ? 1 : 0)}
            />
          </Cell>
          <CellGroup title="提醒方式">
            <Cell>
              <AlarmRadio
                type="alarmType"
                defaultValue={alarmType.toString()}
                onChange={(e) => setAlarmType(Number.parseInt(e.detail))}
              ></AlarmRadio>
            </Cell>
          </CellGroup>
