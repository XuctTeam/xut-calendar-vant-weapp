 ...
 * @LastEditTime: 2022-09-23 17:28:28
 * @FilePath: \xut-calendar-vant-weapp\src\pages\index\component\DayEventFullDay.tsx
 * @Description:
 *
...
const DayEventFullDay: FunctionComponent<IPageOption> = (props) => {
  return (
    <View className='full-day'>
      <View className='title'>全天</View>
      <View className='list'>
        {props.componentList.map((i, index) => {
          return (
            <View key={index} className='full-box' onClick={() => props.viewComponent(i)}>
