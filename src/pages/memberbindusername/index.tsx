 ...
 * @LastEditTime: 2022-08-08 11:24:09
...
import { Button, Cell, CellGroup, Form, FormItem, Unite } from '@antmjs/vantui'
...
export default Unite(
  {
    ...
    bindUserName() {
      this.hooks['form'].validateFields(
        (errorMessage: any, fieldValues: any) => {
